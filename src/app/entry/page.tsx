    ...
    sets: [
      {
        ...
        questions: [
          ...
          {
            id: 'g3_p1_q2',
            text: 'In the second stage of the following task____',
          ...
          {
            id: 'g3_p1_q3',
            text: 'During the whole task____',
            optionA: 'I may use external AI tools, search engines, or other external tools for additional assistance.',
            optionB: 'I may not use external AI tools, search engines, or other external tools for additional assistance.',
            correct: 'B',
          },
        ],
      },
