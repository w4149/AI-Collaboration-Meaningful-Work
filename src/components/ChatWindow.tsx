    ...
    <Card className="h-full flex flex-col">
      <CardHeader className="pb-2 border-b">
        ...
        <div className="text-xs text-amber-700 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2 leading-relaxed mt-2">
          <strong className="font-semibold">Reminder:</strong> The AI assistant has not seen the task instructions or materials. Please share any information it needs when you interact with it.
        </div>
      </CardHeader>
