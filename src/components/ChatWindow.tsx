      ...
      <CardHeader className="pb-2 border-b">
        ...
        <div className="text-xs text-amber-700 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2 leading-relaxed mt-2">
          ...
          {groupType === 'G3-HumanAndAI'
            ? 'Use the AI assistant to review and improve your initial response. Please paste your initial response along with the complete task instructions and materials into the chat.'
            : 'Use the AI assistant to complete the task. Please paste the complete task instructions and materials into the chat.'}
        </div>
      </CardHeader>
